...
const Bg = styled.div`
  ${tw`dark:bg-gray-900 dark:text-gray-200`}
`;
...
const Wrapper = styled.main`
  ...
  a {
    ${tw`text-blue-700 print:text-black dark:text-blue-400`}
...
const Sidebar = styled(_Sidebar)`
  ${tw`grid-row[2] grid-column[1] print:grid-column[span 2] print:border-b-4 dark:border-b-gray-800`}
`;
