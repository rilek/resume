...
const fontBlack = fetch(new URL("../../assets/SourceSerifPro-Black.ttf", import.meta.url)).then(
  (res) => res.arrayBuffer(),
);

const fontRegular = fetch(new URL("../../assets/SourceSerifPro-Regular.ttf", import.meta.url)).then(
  (res) => res.arrayBuffer(),
);
